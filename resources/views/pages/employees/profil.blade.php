            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('pages.employees.all')}}"> Retour</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            <h3 class="user-name m-t-0 mb-0">{{ $employee->firstname}} {{ $employee->secondname}}</h3>
                                            <h6 class="text-muted">{{ $employee->departement}}</h6>
                                            ...
                                            <!-- message button
                                            <div class="staff-msg"><a class="btn btn-custom" href="apps-chat">Send
                                                    Message</a></div>
                                            -->
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            <li>
                                                ...
                                                <div class="text"><a href="">{{ $employee->phonenumber}}</a></div>
                                            </li>
                                            <li>
                                                <div class="title">Email:</div>
                                                <div class="text"><a href=""><span class="__cf_email__"
                                                            data-cfemail="bfd5d0d7d1dbd0daffdac7ded2cfd3da91dcd0d2">{{ $employee->email}}</span></a>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div class="text">{{ $employee->addresse}}</div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="text">
                                                    <div class="avatar-box">
                                                        <div class="avatar avatar-xs">
                                                            <img src="https://smarthr-ci.dreamguystech.com/template/blue/public/assets/img/profiles/avatar-16.jpg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                    <a href="profile">
                                    ...
                                    <ul class="team-members">
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" title="Jeffery Lalor"><img alt=""
                                                    src="https://smarthr-ci.dreamguystech.com/template/blue/public/assets/img/profiles/avatar-16.jpg"></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="project-members m-b-15">
                                    ...
                                    <ul class="team-members">
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" title="John Doe"><img alt=""
                                                    src="https://smarthr-ci.dreamguystech.com/template/blue/public/assets/img/profiles/avatar-02.jpg"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" title="Richard Miles"><img alt=""
                                                    src="https://smarthr-ci.dreamguystech.com/template/blue/public/assets/img/profiles/avatar-09.jpg"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" title="John Smith"><img alt=""
                                                    src="https://smarthr-ci.dreamguystech.com/template/blue/public/assets/img/profiles/avatar-10.jpg"></a>
                                        </li>
                                        <li>
                                            <a href="#" data-bs-toggle="tooltip" title="Mike Litorus"><img alt=""
                                                    src="https://smarthr-ci.dreamguystech.com/template/blue/public/assets/img/profiles/avatar-05.jpg"></a>
                                        </li>
                                        <li>
